...
local DEFAULT_THEME = {
	...
	Element = Color3.fromRGB(20, 60, 110),
	ElementHover = Color3.fromRGB(26, 76, 134),
	ElementLine = Color3.fromRGB(30, 81, 132),
	Field = Color3.fromRGB(8, 26, 50),
	FieldRaised = Color3.fromRGB(26, 76, 134),
...
function Card:AddMultiDropdown(text, options, default, callback)
	...
	local function paintEntry(entry)
		...
		tween(entry.button, TI_FAST, {
			...
			TextColor3 = selected and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(235, 247, 255),
		})
